...
- [ROADMAP.md](../contribute/ROADMAP.md) — sidecar 1.0; optional LLM; snowball phases
- [snowball.md](../paths/snowball.md) — keyword / DOI / ORCID / collection library building (path + details)
