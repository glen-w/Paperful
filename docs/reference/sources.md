...
| `scihub` | DOI, and either undated or year ≤ 2021 (Sci-Hub largely stopped ingesting after ~2021; see [Sci-Hub](../howto/scihub.md#coverage-cutoff-2021)) |
...
| `ezproxy` | `ezproxy_base` plus a session (vault or cookie file), **and** a DOI or a URL on a [known publisher host](../howto/ezproxy.md#what-ezproxy-will-try) |
