...
Design rules (see [architecture § LLM layer](../explain/architecture.md#llm-layer-optional-local-first)):
...
Full key table: [Configuration § LLM](../reference/config.md#llm-optional-local-first).
...
- [config.md](../reference/config.md#llm-optional-local-first) — key reference
- [commands.md](../reference/commands.md) — `recover` / `summarize` / `synthesize` flags and exit codes
- [architecture.md](../explain/architecture.md#llm-layer-optional-local-first) — layer, gates, note write path
- [sessions.md](sessions.md) — vault profile ownership during `recover`
- [ROADMAP.md](../contribute/ROADMAP.md#optional-llm-assist-local-litellm) — what is later (Cloud/BU2, playbook mining)
