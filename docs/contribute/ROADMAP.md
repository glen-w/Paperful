...
- **Quiet mirror** — [quiet-mirror.md](../paths/quiet-mirror.md). **Shipped:** `snapshot`
...
See [architecture § LLM layer](../explain/architecture.md#llm-layer-optional-local-first).
...
are in the tree. Contract: [snowball.md](../paths/snowball.md). Still later:
...
3. **Identity / resolver graph** — work ↔ version ↔ preprint; scored patches with
   ...
   [Snowball](../paths/snowball.md) section above, not a line item inside this graph.
...
- [architecture.md](../explain/architecture.md) — disk-first adapters and data flow
